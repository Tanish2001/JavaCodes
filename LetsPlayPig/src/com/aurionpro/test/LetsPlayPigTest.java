...
import com.aurionpro.model.LetsPlayPig;

public class LetsPlayPigTest {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		LetsPlayPig player1 = new LetsPlayPig();
		LetsPlayPig player2 = new LetsPlayPig();
		startGame(player1, 1);
	}

	private static void startGame(LetsPlayPig player1, int turn) {
